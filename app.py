# ==============================================================================
# Final Definitive app.py (With Dated Citations & Recency Prioritization)
# ==============================================================================
...
def stream_paper_generation(initial_context, field_area_text, chosen_title, all_titles, results_analysis_text=""):
    ...
    try:
        ...
        # <<< MODIFICATION: UNIVERSAL SYSTEM PROMPT FOR THIS FEATURE >>>
        system_prompt = (
...
def stream_combination_with_progress(p1_content, p2_content, p3_content, chosen_title):
    ...
    try:
        ...
        for i, section_title in enumerate(sections_to_synthesize):
            ...
            # <<< MODIFICATION: HARDENED PROMPTS FOR COMBINE FEATURE >>>
            general_prompt = (
            ...
            prompt_to_use = ""
            if section_title == "Conceptual Framework and Hypotheses":
                prompt_to_use = (
...
def stream_paper_augmentation(base_paper_content, source_contents, source_filenames):
    ...
    try:
        ...
        for i, content in enumerate(source_contents):
            summary_prompt = "Summarize the key arguments, findings, and definitions from this paper for later use. Ensure all citations include the year, like (Author, YYYY)."
        ...
        for i, section_data in enumerate(paper_sections):
            ...
            # <<< MODIFICATION: HARDENED PROMPTS FOR AUGMENT FEATURE >>>
            augmentation_prompt = (
